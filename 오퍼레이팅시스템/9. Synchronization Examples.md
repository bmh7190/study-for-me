...
#### 어떻게 하면 Deadlock을 피할 수 있을까?

젓가락에 비해 테이블에 사람들이 많기 때문에, 사람의 수를 줄여서 젓가락 2개 씩 가질 수 있도록 하자!

지금 왼쪽 젓가락과 오른쪽 젓가락을 순차적으로 얻으려고 하기 때문에 문제가 발생했다. 따라서 왼쪽 젓가락과 오른쪽 젓가락을 동시에 얻을 수 있도록 하면 해결 할 수 있다! 즉 젓가락 집는 행위를 critical section안에서만 이뤄질 수 있도록 한다!

젓가락을 항상 같은 방향(왼쪽 -> 오른쪽 )으로 집고 있기 때문에, 발생한다. 따라서 젓가락 집는 순서를 철학자마다 다르게 한다면 해결할 수도 있다! 홀수 철학자는 왼쪽부터 들게 하고, 오른쪽을 들게 하고, 짝수 철
