...
내가 Resource-Request 를 들어줬다고, 가정하고, unsafe state로 판단되면 들어주면 안된다. 판단하는 과정은 위에서 정리한 safety 알고리즘을 똑같이 사용한다.

![](../images/Pasted%20image%2020250521232119.png)

P0 ( 0, 2, 0 )을 요청했다면 들어줬다고 가정했다면 P0는 ( 0, 3, 0 )이 된다. 또 그만큼 사용했으니까 
