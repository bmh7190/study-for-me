...
그나마 가장 현실성 있는 Circular wait을 안 만드는 방법을 사용해보자

기존에 아무런 정보 없이 Circular wait을 방지하기는 어렵고, 몇 가지 사전 정보를 얻는다면 방지할 수 있을 것이다. 가장 쉽고, 이용 가능한 것은 각각의 프로세스들이 필요한 각 종류의 리소스들의 최대 크기를 안 다고 가정하자
