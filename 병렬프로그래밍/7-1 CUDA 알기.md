...
![](../images/Pasted%20image%2020251122183707.png)
...
위에서 설명한 grid·block 구조는 우리가 **쓰레드를 논리적으로 어떻게 나누어 생각할지**에 대한 개념적인 단위이고, 실제로 하드웨어에서는 이 쓰레드들이 **SM(Stream Multiprocessor)** 위에 매핑되어 실행된다. 이때 몇 가지 중요한 규칙이 있다.
