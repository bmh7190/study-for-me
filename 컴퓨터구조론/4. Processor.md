...
컴파일러가 여러 instruction을 하나의 packet으로 묶을 때는 어떤 조금의 hazard도 있어서는 안된다. 그래서 inssue packet으로 묶을 때 instruciton의 순서를 재배치를 하기도 하고, instruction 사이에 의존성도 없게 한다.


아무리 여러 instruction을 묶으려고 시도해봐도 전부 의존성을