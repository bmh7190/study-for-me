...
레지스터를 4개 읽어야 하므로, 레지스터로 들어가는 거 2배, 나오는 것도 2배, 위에는 ALU용 ALU 연산기 추가되어야 하고, lw,/sw용 주소 계산용 연산기도 있어야 하기 때문에 ALU 하나더 추가!  또 레지스터 쓰기용도 2개
...
load-use hazard의 경우 한 사이클 정도 nop으로 채워 보낸다면 2 d
