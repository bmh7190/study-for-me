...
파이프라인 길을 만들 때, 완전히 2개를 복사하게 되면, 모든 길마다 같은 일을 하게하려면 자원이 2배가 필요하기 때문에 손해다. 

그래서 길들의 역할을 나눠서 한 길을 ALU/branch 하나랑Load/Store을 하나로 묶는거다! 
만약 둘 중에 하나가 업승면 nop을 채우게 되겠죠?