...
비슷비슷하지만 arm 은 Data addressing modes가 MIPS 보다 더 많지만 레지스터 자체의 수는 더 적다.

수학 / 논리 명령의 결과를 나타내는 상태 코드를 사용한다.
negative, zero, carry, overflow
compare instrucitons to set condition odes without keeping the result
